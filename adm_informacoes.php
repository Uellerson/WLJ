...
<body>
    <nav class=" navbar  navbar-expand-lg navbar-dark bg-primary border-bottom shadow-sm ">
        <div class="container-fluid">
            ...
            <div class="box-search d-flex justify-content-center pt-2 col">
                <input class=" form-control me-2" type="search" placeholder="O que você está procurando?" id="pesquisar"
                    name="pesquisar" class="">
            </div>
            ...
            <div class="align-self end ">
                ...
                <div class="navbar-collapse collapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <?php }else{ ?>
                        <li class="nav-item">
                            <a href="informacoes_usuario.php" class="m-2 nav-link  text-white"> Bem vindo
                                <?php echo $_SESSION['nome']; ?></a>
                        </li>
                        <?php } ?>

                        <li class="nav-item">
                            <a class="btn btn-primary m-2  nav-link text-white" data-bs-toggle="offcanvas"
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class=" offcanvas-body border">
            ...
            <p class="fs-5 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <ul class="sticky-top nav nav-pills nav-fill navbar-light bg-light border">
        ...
        <li class="nav-item d-none d-md-block">
            ...
            <a class="nav-link" href="categoria.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <li class="nav-item d-inline-block d-md-none">
            <a class="nav-link text-dark" href="#">
                ...
                <a class="nav-link text-dark" href="#"><img id="chuteira-icon" src="img/vans-svgrepo-com.svg"
                        class="bi " width="20" height="20"></a>
        </li>
        <li class="nav-item d-inline-block d-md-none">
    ...
    <main>
        ...
        <div class="container py-2 d-flex text-center">
            ...
            <div class="card shadow col">
                <div class="card-header">
                    <h4>Informações cartão:</h4>
                </div>
                <?php
                    $comando = $pdo->prepare("SELECT * FROM cartao WHERE id_usuario = $id_usuario");

                    $comando->execute();
                    if(($comando) AND ($comando->rowCount() != 0 )){
                ...
                echo("<h5 class='my-3'> Não há cartão cadastrado </h5>");
            }
            ?>
            </div>
