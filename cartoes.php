                    ...
                    <div class="text-muted card-body p-5">
                        <div class="fw-bold d-flex align-items-center justify-content-between">
                            <div class="p-2 card shadow-lg "
                                style="width: 300px; height: 160px; background-image: linear-gradient(160deg, #0093E9 0%, #80D0C7 100%);">
                            ...
                            <button type="button" class="col-7 m-5 btn btn-primary" data-bs-toggle="modal"
                    ...
                    <div class="text-muted card-body  p-3">
                        <div class="fw-bold d-flex align-items-center justify-content-between">
                            <div class="d-none d-md-block p-2 card shadow-lg "
                                ...
                                <img src="https://www.freepnglogos.com/uploads/mastercard-png/mastercard-logo-png-transparent-svg-vector-bie-supply-0.png"
                                    width="60" class="" alt="">
                                    <a style="margin-left:39%;" href="excluir_um_cartao.php?id=<?php echo $linha['id'];?>">
                                ...
                                <p class="m-1"><?php echo $linha['titular'];?></p>
                                <p class="m-1"><?php echo $linha['numero_cartao'];?></p>
                                <div row>
                                <p> <span class="m-1" style="font-size: x-small;"><?php echo $linha['validade']?> </span> <span class="px-3"
